...
namespace UdemyCarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("GetCarCountByTranmissionIsAutoCount")]
        public async Task<IActionResult> GetCarCountByTranmissionIsAutoCount()
        {
            var values = await _mediator.Send(new GetCarCountByTranmissionIsAutoCountQuery());
            return Ok(values);
        }


        [HttpGet("GetCarCountByTranmissionIsManuelCount")]
        public async Task<IActionResult> GetCarCountByTranmissionIsManuelCount()
        {
            var values = await _mediator.Send(new GetCarCountByTranmissionIsManuelCountQuery());
            return Ok(values);
        }
        ...
        {
            var values = await _mediator.Send(new GetCarCountByFuelGasolineOrDiselQuery());
            return Ok(values);
        }
