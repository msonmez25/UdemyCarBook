...
namespace UdemyCarBook.Persistence.Context
{
    public class CarBookContext:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=082-001-095-10\\SQLEXPRESS;initial Catalog=DbCarBookUdemy;integrated security=true;TrustServerCertificate=true");
        }
        ...
        public DbSet<Vites> Viteses { get; set; }
